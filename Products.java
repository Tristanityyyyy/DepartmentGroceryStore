...
public class Products {
	static Queue <String> usernames = new LinkedList();
	static Queue <String> passwords = new LinkedList();
	...
	public static void login() {	
			...
			switch(sign) {
				case 'L':
					...
					if(usern.equals("cashier") && pass.equals("cashier123")) {
						System.out.println("\t \t \t \t" + "Account successfully logged in.");
						System.out.println("\t \t \t==================================================================================================================");
					}
					else if(usern.equals("admin") && pass.equals("admin123")) {
						System.out.println("\t \t \t \t" + "Account successfully logged in.");
						System.out.println("\t \t \t==================================================================================================================");
						Admin.invent();
						//ADMIN CALLING
					}
					else if(usernames.contains(usern) && passwords.contains(pass)) {
						System.out.println("\t \t \t \t" + "Account successfully logged in.");
						System.out.println("\t \t \t==================================================================================================================");
					}
					else {
